      ...
      >
        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
          ...
          <div className="relative h-64 lg:h-72 overflow-hidden group/image">
            ...
            <div className="absolute top-4 left-4 flex flex-wrap gap-2 z-10">
              {property.badges.map((badge, idx) => (
                <span
                  key={idx}
                  className={`px-3 py-1 rounded-full text-xs font-bold text-white backdrop-blur-sm animate-in fade-in-left slide-in-from-left-4 duration-500 ${
                    badge === "Featured"
                      ? "bg-secondary-500/90"
                      : badge === "New Listing"
                        ? "bg-primary-600/90"
                  ...
                  style={{
                    animationDelay: `${index * 100 + idx * 100}ms`,
                  }}
                >
                  {badge}
                </span>
          ...
          <div className="p-5 lg:p-6">
            ...
            {/* Title */}
            <h3 className="text-lg font-bold text-primary-900 mb-2 line-clamp-2 group-hover:text-secondary-600 transition-colors cursor-pointer">
              {property.title}
            </h3>
