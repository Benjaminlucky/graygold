        ...
        <div className="relative z-10 space-y-12">
          ...
          <div className="space-y-3">
            <ContactCard
              ...
              delay={0}
              title="Phone"
              lines={["+234 (0)80 6011 7072", "+234 (0)81 2632 6511"]}
              icon={
                <svg
            ...
            />
            <ContactCard
              href="mailto:sales@graygoldrealty.com"
              delay={100}
              title="Enquiries From Graygold Realty"
              lines={[
                "customercare@graygoldrealty.com",
                "sales@graygoldrealty.com",
              ]}
              icon={
                <svg
                  className="w-5 h-5 text-secondary-400 group-hover:text-white transition-colors duration-300"
            ...
            />
            <ContactCard
              href="https://maps.app.goo.gl/hoPvxc1CWFeMMXHG6"
              delay={200}
              title="Corporate Headquarters"
              lines={[
                "Suite A12, Princess and Angel mall, Eti-Osa, Sangotedo 106104, Lagos"
              ]}
              icon={
                <svg
                  className="w-5 h-5 text-secondary-400 group-hover:text-white transition-colors duration-300"
